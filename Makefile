.PHONY: help deps fmt unit-tests integration-tests all-tests staticcheck verify start stop watch-tests watch-unit-tests watch-integration-tests docker-up docker-up-dev docker-down docker-build
.DEFAULT_GOAL := help
